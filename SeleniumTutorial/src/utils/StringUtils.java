...
public class StringUtils {
	...
	public static String urlBuilder(String urlStr) throws Exception {
		// String urlStr =
		// "http://10.174.32.74/repos/EEF/EEF-TestAutomation/branch/Automation_AREEF/Datapool/TestDataPool_Automation.xlsx";
	...
	// String x="";
	// x=new Rft().getAllTextInPageTable(".tag","TABLE", ".className",
